...
class King(Piece):
    ...
    def __init__(self, xPos, yPos, color):
        """
        New King Piece at position xPos, yPos, and the color"""
            ...
            if self.color:
                if type(chessboard[int(self.color)][7][0]) is Rook:
                    if not chessboard[int(self.color)][7][0].moved:
                        if chessboard[int(self.color)][7][1] == " " and \
                                chessboard[int(self.color)][7][2] == " " and \
                                chessboard[int(self.color)][7][3] == " ":
                            if chessboard[int(not self.color)][7][1] == " " and \
                                    chessboard[int(not self.color)][7][2] == " " and \
                                    chessboard[int(not self.color)][7][3] == " ":
                ...
                if type(chessboard[int(self.color)][0][0]) is Rook:
                    if not chessboard[int(self.color)][0][0].moved:
                        if chessboard[int(self.color)][0][1] == " " and \
                                chessboard[int(self.color)][0][2] == " " and \
                                chessboard[int(self.color)][0][3] == " ":
                            if chessboard[int(not self.color)][0][1] == " " and \
                                    chessboard[int(not self.color)][0][2] == " " and \
                                    chessboard[int(not self.color)][0][3] == " ":
                                self.availableMoves.append([[self.pos[0], self.pos[1]], [self.pos[0] - 2, self.pos[1]]])
                if type(chessboard[int(self.color)][0][7]) is Rook:
                    if not chessboard[int(self.color)][0][7].moved:
                        if chessboard[int(self.color)][0][6] == " " and chessboard[int(self.color)][0][5] == " ":
                            if chessboard[int(not self.color)][0][6] == " " and \
                                    chessboard[int(not self.color)][0][5]:
                                self.availableMoves.append([[self.pos[0], self.pos[1]], [self.pos[0] + 2, self.pos[1]]])
